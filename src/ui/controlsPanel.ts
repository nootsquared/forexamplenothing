...
const LINES: ControlLine[] = [
  ...
  { action: 'WITH THE BALL', keys: [], pad: [], gap: true, head: true },
  { action: 'FEINT — SWAY THEN GO', keys: [k('K')], pad: [k('B', CORAL)] },
  { action: 'CROQUETA — SIDE SHIFT', keys: [k('J')], pad: [k('X', SKY)] },
  { action: 'RAINBOW — OVER HIM', keys: [k('L')], pad: [k('Y', GOLD)] },
  { action: 'WITHOUT THE BALL', keys: [], pad: [], gap: true, head: true },
  { action: 'TACKLE — WIN IT OR MISS IT', keys: [k('K')], pad: [k('B', CORAL)] },
  { action: 'SLIDE — FROM BEHIND IS A FOUL', keys: [k('J')], pad: [k('X', SKY)] },
  { action: 'BARGE A SHIELDER', keys: [k('L')], pad: [k('Y', GOLD)] },
  { action: 'BREAK ON A CORNER', keys: [k('SPACE')], pad: [k('B', CORAL)], gap: true },
...
const SEAT_TWO: ControlLine[] = [
  ...
  { action: 'FEINT / TACKLE', keys: [k('COMMA')], pad: [k('COMMA')] },
  { action: 'CROQUETA / SLIDE', keys: [k('SEMI')], pad: [k('SEMI')] },
  { action: 'RAINBOW / BARGE', keys: [k('QUOTE')], pad: [k('QUOTE')] },
